...
//    System.out.println("5. Mostrar pontuação");
...
//            break;
//        case 5: 
//                System.out.println("Sua pontuação é: "  + pontuacao + " Acertos");
//                break;
//        case 6: 
...
//         double temperatura, saturacao;
//         String tosse, ar;
//         System.out.println("Informe em quanto está sua temperatura:");
//         temperatura = input.nextDouble();
//         System.out.println("Está com tosse? (S/N)");
//         tosse = input.next();
//         System.out.println("Está com falta de ar? (S/N)");
//         ar = input.next();
//         System.out.println("Informe em quanto está sua saturação: ");
//         saturacao = input.nextDouble();
//         if(temperatura < 37.5){
//             System.out.println("Normal");
//         }else if(temperatura >= 38 && tosse.equalsIgnoreCase("S")){
//             System.out.println("Suspeita Infecciosa");
//         }else if(temperatura >=39 && ar.equalsIgnoreCase("S") && saturacao < 92){
//             System.out.println("Emergência");
//         }
//         else if(temperatura > 37.5 && saturacao >=92 || temperatura <=38.9 && tosse.equalsIgnoreCase("N") || temperatura >=39 && ar.equalsIgnoreCase("N")){
//             System.out.println("Monitoramento");
//         }
//         System.out.println("-------------EXERCICIO 10--------------");
//         Integer numero = 0, rg, cpf, codigo;
//         String alterar, excluir;
//         do{
...
//                    alterar = input.next();
//                    if(alterar.equalsIgnoreCase("RG")){
//                      System.out.println("Informe seu número de RG: ");
//                      rg = input.nextInt();
//                    }else if(alterar.equalsIgnoreCase("CPF")){
//                      System.out.println("Informe seu número de CPF: ");
//                      cpf = input.nextInt();
//                    }else if(alterar.equalsIgnoreCase("Código") || alterar.equalsIgnoreCase("Codigo")){
//                      codigo = input.nextInt();
//                    }
//                    
//                   break;
//                    
//             case 3: 
//                    System.out.println("Qual dado deseja excluir?");
//                    excluir = input.next();
//                    if(excluir.equalsIgnoreCase("RG")){
//                       rg = null;
//                    }else if(excluir.equalsIgnoreCase("CPF")){
//                       cpf = null;
//                    }else if(excluir.equalsIgnoreCase("Código") || excluir.equalsIgnoreCase("Codigo")){
//                        codigo = null;
//                    }
//                    break;
//             case 4: 
